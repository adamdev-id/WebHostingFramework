    ...
    <div class="container">
        ...
        <table id="main-table" class="table" style="background-color: #FFFFFF;">
            <thead>
                ...
                <th scope="col" style="width: 15%">Upgrade ID</th>
                <th scope="col" style="width: 15%">RAM</th>
                <th scope="col" style="width: 13%">Storage</th>
                <th scope="col" style="width: 13%">CPU</th>
            ...
            <tbody>
                <?php 
                    $nomor = 1;
                    $query = mysqli_query($conn, "SELECT upgrade.ID, upgrade.Upgrade_ID, upgrade_parts.RAM, upgrade_parts.Storage, upgrade_parts.CPU, DATE_FORMAT(upgrade.Purchase_Date, '%d %M %Y') AS Purchase_Date, upgrade.Total FROM upgrade INNER JOIN upgrade_parts ON upgrade.Upgrade_ID=upgrade_parts.ID ORDER BY upgrade.ID ASC");
